...
shinyServer <-  function(input, output, session) {
  ...
  # #mixing
  # useimputation=TRUE,
  # threshyear = 2008, FinalGroups = 5, w_imemA = 0.1, w_imemB = 0.25, 
  # w_metaA = 0.1, w_metaB = 0.15, w_modelA = 0.8,w_modelB = 0.6){
  #   
...
shinyUI <- fluidPage(
  ...
  fluidRow(
    column(width = 9,
           ...
           # tags$head(tags$style("dataTable thead .sorting:after {color : yellow; opacity: 0.6;}", media="screen", type="text/css")),
           # tags$head(tags$style("dataTable thead .sorting_asc:after {color : yellow; opacity: 0.6;}", media="screen", type="text/css")),
           # tags$head(tags$style("dataTable thead .sorting_desc:after {color : yellow; opacity: 0.6;}", media="screen", type="text/css")),
           # 
           ...
           tabsetPanel(type='tabs',
                       ...
                       tabPanel(title = PanelNames[2],
                                ...
                                sidebarPanel(width=12,
                                  ...
                                  #//*[@id="DataTables_Table_0"]/tbody/tr[4]/td[5]
                                  # tags$head(tags$style("@DataTables_Table_0 tbody {padding:0px;}", media="screen", type="text/css")),
                                  # tags$head(tags$style("@table1 table th {padding:0px;}", media="screen", type="text/css")),
                                  # tags$head(tags$style("@table1 table tr {padding:0px;}", media="screen", type="text/css")),
                                  br(), br()
                                ),
                                sidebarPanel(width=12,
                                             h3("References"),
                       ...
                       tabPanel(title = PanelNames[4],
                                ...
                                sidebarPanel(
                                  ...
                                  #div(id = 'corrItab', class = "shiny-html-output",style="border-color: red; border: red;"),
                                  ...
                                  conditionalPanel(condition = "input.Iraymer > 0",
                                                   ...
                                                   # this should appear conditioaaly to the reference countries
                                                   
                                                   # radioButtons("Iadditivive", label = h3("Radio buttons"),
                                ...
                                sidebarPanel(width=8,
                                             ...
                                             # tags$head(tags$style("#ITranslateGroups form-group {margin-bottom: 0px;}", media="screen", type="text/css")),
                                             # tags$head(tags$style("#ITranslateGroups div.form-group.shiny-input-container {margin-bottom: 1px;}", media="screen", type="text/css")),
                                             # tags$head(tags$style("#ITranslateGroups div.form-group {margin-bottom: 2px;}", media="screen", type="text/css")),
                                             # tags$head(tags$style("#ITranslateGroups shiny-input-container {margin-bottom: 3px;}", media="screen", type="text/css")),
                                             # tags$head(tags$style("#ITranslateGroups .form-group.shiny-input-container {margin-bottom: 4px;}", media="screen", type="text/css")),
                                             # tags$head(tags$style("#ITranslateGroups .form-group {margin-bottom: 17px;}", media="screen", type="text/css")),
                                             # tags$head(tags$label("#ITranslateGroups .form-group {margin-bottom: 27px;}", media="screen", type="text/css")),
                                             # tags$head(tags$style("#ITranslateGroups .shiny-input-container {margin-bottom: 5px;}", media="screen", type="text/css")),
                                             # tags$head(tags$style(".shiny-input-container {margin-bottom: 6px;}", media="screen", type="text/css")),
                                             tags$head(tags$style("#Izupa .form-group.shiny-input-container {margin-bottom: 0px;}", media="screen", type="text/css")),
                                             #tags$head(tags$style("col-sm-8.form-group.shiny-input-container {margin-bottom: 8px;}", media="screen", type="text/css")),
                                             # tags$head(tags$style("shiny-input-container {margin-bottom: 8px;}", media="screen", type="text/css")),
                                             # tags$head(tags$style("form-group.shiny-input-container {margin-bottom: 9px;}", media="screen", type="text/css")),
                                             # tags$head(tags$style("form-group {margin-bottom: 10px;}", media="screen", type="text/css")),
                                             # tags$head(tags$style(".form-group {margin-bottom: 11px;}", media="screen", type="text/css")),
                                             # <div class="form-group shiny-input-container __web-inspector-hide-shortcut__">
                                             #   <label class="control-label" id="ITranslateGroups-label" for="ITranslateGroups">Model sensitivity</label>
                                             #   <span class="irs irs--shiny js-irs-7 irs-with-grid"><span class="irs"><span class="irs-line" tabindex="0"></span><span class="irs-min" style="visibility: visible;">2</span><span class="irs-max" style="visibility: visible;">10</span><span class="irs-from" style="visibility: hidden;">0</span><span class="irs-to" style="visibility: hidden;">0</span><span class="irs-single" style="left: 36.8189%;">5</span></span><span class="irs-grid" style="width: 95.4751%; left: 2.16243%;"><span class="irs-grid-pol" style="left: 0%"></span><span class="irs-grid-text js-grid-text-0" style="left: 0%; margin-left: -1.13267%;">2</span><span class="irs-grid-pol small" style="left: 8.333333333333332%"></span><span class="irs-grid-pol small" style="left: 4.166666666666666%"></span><span class="irs-grid-pol" style="left: 12.5%"></span><span class="irs-grid-text js-grid-text-1" style="left: 12.5%; visibility: visible; margin-left: -1.13267%;">3</span><span class="irs-grid-pol small" style="left: 20.833333333333332%"></span><span class="irs-grid-pol small" style="left: 16.666666666666664%"></span><span class="irs-grid-pol" style="left: 25%"></span><span class="irs-grid-text js-grid-text-2" style="left: 25%; visibility: visible; margin-left: -1.13267%;">4</span><span class="irs-grid-pol small" style="left: 33.333333333333336%"></span><span class="irs-grid-pol small" style="left: 29.166666666666664%"></span><span class="irs-grid-pol" style="left: 37.5%"></span><span class="irs-grid-text js-grid-text-3" style="left: 37.5%; visibility: visible; margin-left: -1.13267%;">5</span><span class="irs-grid-pol small" style="left: 45.833333333333336%"></span><span class="irs-grid-pol small" style="left: 41.666666666666664%"></span><span class="irs-grid-pol" style="left: 50%"></span><span class="irs-grid-text js-grid-text-4" style="left: 50%; margin-left: -1.13267%;">6</span><span class="irs-grid-pol small" style="left: 58.333333333333336%"></span><span class="irs-grid-pol small" style="left: 54.166666666666664%"></span><span class="irs-grid-pol" style="left: 62.5%"></span><span class="irs-grid-text js-grid-text-5" style="left: 62.5%; visibility: visible; margin-left: -1.13267%;">7</span><span class="irs-grid-pol small" style="left: 70.83333333333333%"></span><span class="irs-grid-pol small" style="left: 66.66666666666667%"></span><span class="irs-grid-pol" style="left: 75%"></span><span class="irs-grid-text js-grid-text-6" style="left: 75%; visibility: visible; margin-left: -1.13267%;">8</span><span class="irs-grid-pol small" style="left: 83.33333333333333%"></span><span class="irs-grid-pol small" style="left: 79.16666666666667%"></span><span class="irs-grid-pol" style="left: 87.5%"></span><span class="irs-grid-text js-grid-text-7" style="left: 87.5%; visibility: visible; margin-left: -1.13267%;">9</span><span class="irs-grid-pol small" style="left: 95.83333333333333%"></span><span class="irs-grid-pol small" style="left: 91.66666666666667%"></span><span class="irs-grid-pol" style="left: 100%"></span><span class="irs-grid-text js-grid-text-8" style="left: 100%; margin-left: -1.64713%;">10</span></span><span class="irs-bar irs-bar--single" style="left: 0px; width: 38.0656%;"></span><span class="irs-shadow shadow-single" style="display: none;"></span><span class="irs-handle single" style="left: 35.8032%;"><i></i><i></i><i></i></span></span><input class="js-range-slider irs-hidden-input shiny-bound-input" id="ITranslateGroups" data-skin="shiny" data-min="2" data-max="10" data-from="5" data-step="1" data-grid="true" data-grid-num="8" data-grid-snap="false" data-prettify-separator="" data-prettify-enabled="false" data-keyboard="true" data-data-type="number" tabindex="-1" readonly="">
                                             #   </div>
                                             #)
                                ),
                                #br(),br(),
                                ...
                                #   <button class="btn radiobtn btn-danger active">
                                #   <span class="radio-btn-icon-yes">
                                #   <i class="fa fa-check-square" role="presentation" aria-label="check-square icon"></i>
                                #   </span>
                                #   <span class="radio-btn-icon-no"></span>
                                #   <input type="radio" autocomplete="off" name="Ipanels" value="1" checked="checked">
                                #   Inspect bilateral flows ratios
                                # </button>
                                #   </div>
                                # <button class="btn radiobtn btn-danger active">
                                #   <span class="radio-btn-icon-yes">
                                #   <i class="fa fa-check-square" role="presentation" aria-label="check-square icon"></i>
                                #   </span>
                                #   <span class="radio-btn-icon-no">
                                #   <i class="fa fa-square-o" role="presentation" aria-label="square-o icon"></i>
                                #   </span>
                                #   <input type="radio" autocomplete="off" name="Ipanels" value="2">
                                #   Classification of model undercounting
                                # </button>
                                ...
                                conditionalPanel(condition = "input.Ipanels == 1",
                                                 sidebarPanel(width=8,
                                                              ...
                                                              # tags$hr(style="border-color: black;"),
                                                              # h4(HTML('<b>Bilateral flows ratios for immigration data</b>. The ratio is calculated by dividing flows from a country X to a group of good data quality countries (<b>Reference group of countries</b>) reported by country X by the flows in the same direction reported by the <b>Reference group of countries</b>. The confidence intervals are calculated using percentile bootstrap method.')),
                                                              # 
                                                              #mainPanel(
                                                              br(),
                                ...
                                conditionalPanel(condition = "input.Ipanels == 2",
                                                 sidebarPanel(width=8,
                                                   ...
                                                   # tags$head(tags$style("#Ilogratios table .table.shiny-table > thead > tr > th, {padding-right:0px;padding-left:0px;width:1px;}", media="screen", type="text/css")),
                                                    tags$head(tags$style("#Ilogratios table td {padding-right:0px;padding-left:0px;width:1px;}", media="screen", type="text/css")),
                                                   # tags$head(tags$style("#Ilogratios table tr {padding-right:0px;padding-left:0px;width:1px;}", media="screen", type="text/css")),
                                                   #tags$head(tags$style("#Ilogratios table thead {padding-right:0px;padding-left:0px;width:1px;}", media="screen", type="text/css")),
                                                   # tags$head(tags$style("#Ilogratios table tbody {padding-right:0px;padding-left:0px;width:1px;}", media="screen", type="text/css")),
                                                   # tags$head(tags$style("#Ilogratios table {padding-right:0px;padding-left:0px;}", media="screen", type="text/css")),
                                                   #ags$head(tags$style("#Ilogratios table.shiny-table {padding:1px;}", media="screen", type="text/css")),
                                                   tags$hr(style="border-color: black;"),
                                                   ...
                                                   #tags$head(tags$style("#Ilogratios table td {width:1px; }", media="screen", type="text/css")),
                                                   #tags$head(tags$table(tags$td(width=1)))
                                                 )),
                                conditionalPanel(condition = "input.Ipanels == 3",
                                                 sidebarPanel(width=8,
                                                              ...
                                                              # checkboxInput("INoData", "Mark no data", value = TRUE),
                                                              # tags$hr(style="border-color: black;"),
                                                              #mainPanel(
                                                              ...
                                                              # br(),
                                                              # div(style="display:inline-block;vertical-align:top;",
                                                              #     column(11,checkboxInput("INoData", "Mark no data", value = TRUE))
                                                              # ),
                                                              # 
                                                              # div(style="display:inline-block;vertical-align:top;",
                                                              #     h5('Choose a format and save the plot'),
                                                              #     column(6,selectInput("IformatB", NULL,
                                                              #                          choices = list("pdf" = 'pdf', "png" = 'png',"tiff" = 'tiff'), selected = 1, width='100%')),
                                                              #     column(6,downloadButton("IsaveplotB", "Save plot"))),
                                                              ...
                                                              div(style="display:inline-block;vertical-align:bottom;",
                                                                  column(3,
                                                                         ...
                                                                         #   <div class="checkbox">
                                                                         #   <label>
                                                                         #   <input id="INoData2" type="checkbox" checked="checked" class="shiny-bound-input">
                                                                         #   <span>Mark no data</span>
                                                                         #   </label>
                                                                         #   </div>
                                                                         #   </div>
                       ...
                       tabPanel(title = PanelNames[8],
                                ...
                                sidebarPanel(width=8,
                                             ...
                                             conditionalPanel(condition ="input.Ipanels2 == 3",
                                                              ...
                                                              # checkboxInput("INoData2", "Mark no data", value = TRUE),
                                                              #tags$hr(style="border-color: black;"),
                                                              #mainPanel(
                                                              ...
                                                              #br(),
                                                              # div(style="display:inline-block;vertical-align:top;",
                                                              #   column(11,checkboxInput("INoData2", "Mark no data", value = TRUE))
                                                              # ),
                                                              div(style="display:inline-block;vertical-align:bottom;",
                                                                  column(3,
                                                                         #br(),
